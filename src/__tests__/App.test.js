...
describe("App", () => {
  ...
  describe("can create a new recipe that displays", () => {
    ...
    beforeEach(() => {
      ...
      fireEvent.change(photo, { target: { value: "https://www.foodista.com/sites/default/files/styles/recype/public/017.jpg" } });
    ...
    test("the photo", () => {
      expect(screen.getAllByRole('img')[2]).toHaveAttribute('src', 'https://www.foodista.com/sites/default/files/styles/recype/public/017.jpg');
    });
